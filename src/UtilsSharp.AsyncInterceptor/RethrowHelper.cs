...
namespace UtilsSharp.AsyncInterceptor
{
    internal static class RethrowHelper
    {
        ...
        /// </summary>
        /// <param name="task">The task.</param>
        public static void RethrowIfFaulted(this ValueTask task)
        {
            if (task == null)
                throw new ArgumentNullException(nameof(task));

            if (task.IsFaulted)
                RethrowInnerIfAggregate(task.AsTask().Exception);
        }
        ...
        /// </summary>
        /// <param name="task">The task.</param>
        public static void RethrowIfFaulted<TResult>(this ValueTask<TResult> task)
        {
            if (task == null)
                throw new ArgumentNullException(nameof(task));
