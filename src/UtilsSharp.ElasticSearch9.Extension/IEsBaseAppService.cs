...
namespace UtilsSharp.ElasticSearch9.Extension
{
    ...
    public partial interface IEsBaseAppService : IUnitOfWorkDependency
    {
        ...
        /// <returns></returns>
        ValueTask<BaseResult<string>> Save<T1, T2>(T1 request, Func<T2, IndexResponse> saveFunc) where T1 : EsBaseSaveRequest;
        ...
        /// <returns></returns>
        ValueTask<BaseResult<int>> Delete(EsBaseIdsRequest request, Func<Id[], BulkResponse> deleteFunc);
    ...
    public partial interface IEsBaseAppService
    {
        ...
        /// <returns></returns>
        ValueTask<BaseResult<string>> SaveAsync<T1, T2>(T1 request, Func<T2, Task<IndexResponse>> saveFuncAsync) where T1 : EsBaseSaveRequest;
        ...
        /// <param name="saveFuncAsync">保存方法</param>
        /// <returns></returns>
        ValueTask<BaseResult<int>> BulkSaveAsync<T1, T2>(List<T1> request, Func<List<T2>, Task<BulkResponse>> saveFuncAsync) where T1 : EsBaseSaveRequest;
        ...
        /// <returns></returns>
        ValueTask<BaseResult<int>> IncrementModifyAsync<T>(EsBaseIncrementModifyRequest request, Func<string, Dictionary<string, object>, Task<UpdateResponse<T>>> incrementModifyFuncAsync) where T : class;
        ...
        /// <returns></returns>
        ValueTask<BaseResult<int>> DeleteAsync(EsBaseIdsRequest request, Func<Id[], Task<BulkResponse>> deleteFuncAsync);
