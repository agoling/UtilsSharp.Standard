...
namespace UtilsSharp.ElasticSearch9
{
    ...
    public partial interface IEsBaseDataSource<T> where T : class, new()
    {
        ...
        /// <returns></returns>
        SearchResponse<T> SearchQuery(EsSearchQueryRequest<T> request);
        ...
        /// <param name="request">参数</param>
        /// <returns></returns>
        object SearchScroll(EsSearchScrollRequest<T> request);
    ...
    public partial interface IEsBaseDataSource<T> where T : class, new()
    {
        ...
        /// <param name="request">参数</param>
        /// <returns></returns>
        Task<SearchResponse<T>> SearchQueryAsync(EsSearchQueryRequest<T> request);
        ...
        /// <param name="request">参数</param>
        /// <returns></returns>
        Task<object> SearchScrollAsync(EsSearchScrollRequest<T> request);
