...
namespace ElasticSearch
{
    ...
    public abstract partial class EsBaseDataSource<T> : EsBaseDataAutoMapping<T>, IEsBaseDataSource<T> where T : class, new()
    {
        ...
        /// <returns></returns>
        public virtual IIndexResponse Save(T t, bool refresh = true, string index = "")
        {
        ...
        /// <param name="index">索引</param>
        /// <returns></returns>
        public virtual IBulkResponse Save(List<T> entities, bool refresh = true, string index = "")
        {
        ...
        /// <param name="index">索引</param>
        /// <returns></returns>
        public virtual IUpdateResponse<T> IncrementModify(string id, Dictionary<string, object> incrementModifyParams, bool refresh = true, string index = "")
        {
        ...
        public virtual List<T> Get(string[] ids, string index = "")
        {
            ...
            lists.AddRange(from esResultHits in esResult.Documents where esResultHits.Found select (T)esResultHits.Source);
            return lists;
        }
        ...
        /// <param name="index">索引</param>
        /// <returns></returns>
        public virtual IBulkResponse Delete(string[] ids, bool refresh = true, string index = "")
        {
            var execIndex = !string.IsNullOrEmpty(index) ? index : CurrentIndex;
            var esClient = !string.IsNullOrEmpty(index) ? EsClientByIndex(index) : EsClient;
        ...
        /// <param name="index">索引</param>
        /// <returns></returns>
        public virtual IBulkResponse Delete(List<T> entities, bool refresh = true, string index = "")
        {
            if (entities == null || entities.Count == 0) return new BulkResponse();
            var execIndex = !string.IsNullOrEmpty(index) ? index : CurrentIndex;
            var esClient = !string.IsNullOrEmpty(index) ? EsClientByIndex(index) : EsClient;
    ...
    public abstract partial class EsBaseDataSource<T> where T : class, new()
    {
        ...
        /// <param name="index">索引</param>
        /// <returns></returns>
        public virtual async Task<IIndexResponse> SaveAsync(T t, bool refresh = true, string index = "")
        {
            var execIndex = !string.IsNullOrEmpty(index) ? index : CurrentIndex;
            var esClient = !string.IsNullOrEmpty(index) ? EsClientByIndex(index) : EsClient;
        ...
        /// <param name="index">索引</param>
        /// <returns></returns>
        public virtual async Task<IBulkResponse> SaveAsync(List<T> entities, bool refresh = true, string index = "")
        {
            if (entities == null || entities.Count == 0) return new BulkResponse();
            var execIndex = !string.IsNullOrEmpty(index) ? index : CurrentIndex;
            var esClient = !string.IsNullOrEmpty(index) ? EsClientByIndex(index) : EsClient;
            ...
            if (refresh)
            {
                await esClient.RefreshAsync(execIndex);
            }
            return r;
        }
        ...
        /// <param name="index">索引</param>
        /// <returns></returns>
        public virtual async Task<IUpdateResponse<T>> IncrementModifyAsync(string id, Dictionary<string, object> incrementModifyParams, bool refresh = true, string index = "")
        {
            IUpdateResponse<T> r = new UpdateResponse<T>();
            if (incrementModifyParams == null) return r;
            var execIndex = !string.IsNullOrEmpty(index) ? index : CurrentIndex;
        ...
        /// <param name="index">索引</param>
        /// <returns></returns>
        public virtual async Task<IBulkResponse> DeleteAsync(string[] ids, bool refresh = true, string index = "")
        {
            var execIndex = !string.IsNullOrEmpty(index) ? index : CurrentIndex;
            var esClient = !string.IsNullOrEmpty(index) ? EsClientByIndex(index) : EsClient;
        ...
        /// <param name="index">索引</param>
        /// <returns></returns>
        public virtual async Task<IBulkResponse> DeleteAsync(List<T> entities, bool refresh = true, string index = "")
        {
            if (entities == null || entities.Count == 0) return new BulkResponse();
            var execIndex = !string.IsNullOrEmpty(index) ? index : CurrentIndex;
            var esClient = !string.IsNullOrEmpty(index) ? EsClientByIndex(index) : EsClient;
        ...
        /// <param name="index">索引</param>
        /// <returns></returns>
        public virtual async Task<IClearScrollResponse> ClearScrollAsync(string[] scrollIds, string index = "")
        {
            var esClient = !string.IsNullOrEmpty(index) ? EsClientByIndex(index) : EsClient;
